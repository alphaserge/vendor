  ...
  return (
    ...
    {/* <div style={{ marginBottom: "20px" }} className="product-img" > */}
          ...
          <Box 
             ...
             sx={{ float: "left"}}
           >
             <div class="product-item">{props.data.itemName}</div>
             {/* <div class="product-item">{props.data.refNo}</div>*/}
             <div class="product-item">{props.data.artNo}</div> 
             <div class="product-item">{props.data.design}</div>
             <div class="product-item price"><span>&nbsp;${props.data.price}&nbsp;</span></div>
           </Box>
